...
All notable changes to OPENPROXY are documented here.
...
- `docker compose up` now runs the published `ghcr.io/shivamsharmahere/Open-Proxy:latest`
  image instead of building from source; source builds move to an explicit dev
  override (`docker-compose.dev.yml`, tagged `OPENPROXY:dev`). README,
...
- **Built-in dashboard** — a single embedded HTML file (no Grafana, no config) —
  ...
  (`OPENPROXY --health`) that works `FROM scratch`.
...
[0.6.3]: https://github.com/shivamsharmahere/Open-Proxy/compare/v0.6.2...v0.6.3
[0.6.2]: https://github.com/shivamsharmahere/Open-Proxy/compare/v0.6.1...v0.6.2
[0.6.1]: https://github.com/shivamsharmahere/Open-Proxy/compare/v0.6.0...v0.6.1
[0.6.0]: https://github.com/shivamsharmahere/Open-Proxy/compare/v0.5.0...v0.6.0
[0.5.0]: https://github.com/shivamsharmahere/Open-Proxy/releases/tag/v0.5.0
[0.4.0]: https://github.com/shivamsharmahere/Open-Proxy/releases/tag/v0.4.0
[0.3.0]: https://github.com/shivamsharmahere/Open-Proxy/releases/tag/v0.3.0
[0.2.0]: https://github.com/shivamsharmahere/Open-Proxy/releases/tag/v0.2.0
[0.1.0]: https://github.com/shivamsharmahere/Open-Proxy/releases/tag/v0.1.0
