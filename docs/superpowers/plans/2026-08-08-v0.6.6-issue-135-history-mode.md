...
set -euo pipefail
reviewed_head=$(git rev-parse HEAD)
runs=$(gh api "repos/shivamsharmahere/Open-Proxy/actions/runs?event=pull_request&head_sha=$reviewed_head&per_page=100")
...
test "$remote_head" = "$reviewed_head"
gh pr merge "$issue_pr_url" --repo shivamsharmahere/Open-Proxy \
...
~~~bash
gh issue close 135 --repo shivamsharmahere/Open-Proxy --reason completed \
