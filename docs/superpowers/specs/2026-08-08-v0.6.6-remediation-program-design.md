...
**Umbrella issue:** [#131](https://github.com/shivamsharmahere/Open-Proxy/issues/131)
**Final integration PR:** [#72](https://github.com/shivamsharmahere/Open-Proxy/pull/72)
...
- [#134](https://github.com/shivamsharmahere/Open-Proxy/issues/134) — history-open failure and startup availability
- [#135](https://github.com/shivamsharmahere/Open-Proxy/issues/135) — canonical history file permissions
- [#136](https://github.com/shivamsharmahere/Open-Proxy/issues/136) — compaction temporary-file cleanup
- [#140](https://github.com/shivamsharmahere/Open-Proxy/issues/140) — clock rollback and canonical persistence
- [#139](https://github.com/shivamsharmahere/Open-Proxy/issues/139) — poisoned history-store visibility
...
- [#133](https://github.com/shivamsharmahere/Open-Proxy/issues/133) — bounded per-stream observer state
- [#137](https://github.com/shivamsharmahere/Open-Proxy/issues/137) — deadline finalization
- [#141](https://github.com/shivamsharmahere/Open-Proxy/issues/141) — null usage-details classification
- [#142](https://github.com/shivamsharmahere/Open-Proxy/issues/142) — complete finish-reason accounting

The final PR carries `ci:full`.

### 3. Control and security

- [#138](https://github.com/shivamsharmahere/Open-Proxy/issues/138) — client-key name disclosure
- [#144](https://github.com/shivamsharmahere/Open-Proxy/issues/144) — authorization before PBKDF2 work
- [#145](https://github.com/shivamsharmahere/Open-Proxy/issues/145) — secure session-cookie behavior
- [#143](https://github.com/shivamsharmahere/Open-Proxy/issues/143) — server-settings save semantics
- [#150](https://github.com/shivamsharmahere/Open-Proxy/issues/150) — control-plane concurrency and disclosure

#150 carries `ci:full` and is the workstream promotion PR.

### 4. Presentation and localization

- [#132](https://github.com/shivamsharmahere/Open-Proxy/issues/132) — capacity-table sorting
- [#146](https://github.com/shivamsharmahere/Open-Proxy/issues/146) — prose detection in i18n validation
- [#147](https://github.com/shivamsharmahere/Open-Proxy/issues/147) — standard-vocabulary lint consistency
- [#148](https://github.com/shivamsharmahere/Open-Proxy/issues/148) — render/style fault isolation
- [#149](https://github.com/shivamsharmahere/Open-Proxy/issues/149) — operator feedback and diagnostic accuracy
- [#151](https://github.com/shivamsharmahere/Open-Proxy/issues/151) — locale-canonical, script-independent serving

#151 carries `ci:full` and is the workstream promotion PR.

### 5. Knowledge reconciliation

- [#152](https://github.com/shivamsharmahere/Open-Proxy/issues/152) — reconcile knowledge with shipped code
...
- [#153](https://github.com/shivamsharmahere/Open-Proxy/issues/153) — close gate gaps and rerun the foundation release gate
