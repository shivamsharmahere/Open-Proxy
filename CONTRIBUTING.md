...
Thanks for your interest! OPENPROXY is a small, focused Rust proxy with exactly
...
OPENPROXY **fails closed on purpose** — before setup the data plane is closed
...
Keep the scope tight — OPENPROXY is deliberately small. A change that makes it do
