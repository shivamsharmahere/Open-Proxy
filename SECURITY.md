...
OPENPROXY sits in the request path for every harness and every API key it
...
[Security Advisories](https://github.com/shivamsharmahere/Open-Proxy/security/advisories/new)
...
OPENPROXY has already been through a dedicated security-hardening pass. The
...
- **Supply chain / release integrity.** Every GitHub Actions step is pinned to
  ...
  egress monitoring; an [OpenSSF Scorecard](https://scorecard.dev/viewer/?uri=github.com/shivamsharmahere/Open-Proxy)
...
- Missing TLS. OPENPROXY has **no built-in TLS by design**; terminate TLS at a
...
Thank you for helping keep OPENPROXY and its users safe.
