...
- **Questions and usage help** — open a thread in
  [GitHub Discussions](https://github.com/shivamsharmahere/Open-Proxy/discussions).
  ...
  they do).
- **Bugs** — file a
  [bug report](https://github.com/shivamsharmahere/Open-Proxy/issues/new/choose)
...
OPENPROXY is volunteer-maintained; Discussions and issues are checked
